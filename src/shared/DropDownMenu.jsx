...
const DropDownMenu = ({ list }) => {
    return (
        <div className="absolute bg-gray-800 dark:dark-theme border-none top-[70%] left-0 mt-2 dark:dark-theme shadow-lg p-4 rounded-md w-48 border border-gray-200 overflow-hidden z-10">
